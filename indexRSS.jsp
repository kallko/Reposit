...
<fieldset>
    ...
    <script>
        ...
        option3.text = "http://rssfeeds.usatoday.com/usatoday-NewsTopStories";
        option3.value = "http://rssfeeds.usatoday.com/usatoday-NewsTopStories";
    ...
    function changeRSS(){
        ...
        function delCombo() {
            ...
            for (var index = 0; index < options.length; index ++) {
                if (options[index].value == currentRSS) {
...
<div id="chartContainer" style="height: 400px; width: 400px;  position: absolute; top:140px; left: 800px;"></div>
